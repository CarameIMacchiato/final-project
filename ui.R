      ...
      column(6,
             tags$div(tabsetPanel(type = "tabs",
                                  tabPanel("Explanation",
                                           h2("What is It?"),
                                           p("The Instatistics is an application that uses the instagram API to gather information and statistics on individual instagram users. It has many different features that tells a lot about a user, how they use instagram, and much more. It can search for 2 users at once, so they can be compared"),
                                           h4("Search Bar"),
